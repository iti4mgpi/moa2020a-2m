...
- **Organisateur** : organisation ou individu à responsable de la mise en place (organisation) d'un évènement.
...
Les utilisateurs peuvent gérer les informations qui apparaissent sur leur profil publique (photos, timeline, centres d'intérêts, badges) et peuvent choisir de ne partager leurs informations qu'avec certains utilisateurs désignés. 

Les messages privés sont confidentiels et ne peuvent être consultés que par leurs destinataires.
...
Les nouvelles données doivent être intégrées au système en temps réelle.
...
Les utilisateurs seront en droit d'éxiger une copie des informations le concernant que le système a conservé.
